...
/****** Object:  Database [RailwaySystem]    Script Date: 20-10-2022 19:50:20 ******/
...
CREATE DATABASE [RailwaySystem]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'RailwaySystem', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\RailwaySystem.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'RailwaySystem_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\RailwaySystem_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
